...
func graphRAGCompletePreviewButton() string {
	return `<button type="button" id="graph-complete-preview">Preview complete selected-document graph</button>`
}
